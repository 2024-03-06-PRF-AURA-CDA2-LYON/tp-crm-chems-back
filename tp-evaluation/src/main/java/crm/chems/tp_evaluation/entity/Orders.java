...
public class Orders {
    ...
    public Orders(Long id, @NotBlank String serviceType, @NotNull Double tva, @NotNull Integer nbDays, @NotNull Double totalExcludeTax, Integer state, String comment) {
        this.id = id;
